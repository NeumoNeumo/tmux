...
main() {
  ...
  # message styling
  tmux set-option -g message-style "bg=${gray},fg=${white},fill=${gray},width=100%,align=left"

  # status bar
  tmux set-option -g status-style "bg=${gray},fg=${white},fill=${gray},width=100%,align=left"
